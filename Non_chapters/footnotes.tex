...
\sepfootnotecontent{11_18}{Note: Berestetski\protect\^{\i}, \textit{et al.} (\textit{op. cit.}) define $\gamma^{5}$ with an overall "-" sign relative to Eq. 9.}
