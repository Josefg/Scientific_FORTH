...
\sepfootnotecontent{10_03}{Note that we only need to read in the type and order once, since the array descriptor (Ch. 5\S\ 4 \S\ \S\ 2.5) contains the same information.}
