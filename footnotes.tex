...
\sepfootnotecontent{03_16}{
    The new words are \textbf{FINIT} (initialize 80x87 chip). \textbf{FTRUNC} (set
roundoff mode to truncate ﬂoating point numbers toward zero): and \textbf{FRNDINT}
...
and 11 (numbering from 0) of the 16-bit control word using \textbf{HEX 0C00 OR}. See \textbf{8087P} for
details.}
\sepfootnotecontent{03_17}{
    \textbf{BEHEAD"} is one of several HS/FORTH words thet remove dictionary entries and reclaim lost space.
space. \textbf{BEHEAD'} beheads one word, \textbf{BEHEAD"} behads all words, inclusive, in a range: in this
case, \textbf{BIGDIV, DIVIS. SEED, M1, M2} and \textbf{RAND}.}
