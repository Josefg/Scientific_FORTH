...
\sepfootnotecontent{03_14}{We anticipate using the FORTH assembler - see Ch. 4 1.11 }
...
roundoff mode to truncate ﬂoating point numbers toward zero): and \texttt{FRNDINT}
...
\sepfootnotecontent{03_18} { $N$ is assumed $>> n$ }
\sepfootnotecontent{03_19}{ 
For those interested in details, the probability a PRNG will produce the integer "s" $f$ times is
