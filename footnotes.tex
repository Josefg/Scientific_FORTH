...
\sepfootnotecontent{09_03}{}
This follows from the fundamental theorem of algebra: a polynomial equation, I
p(z): a0 + all + azzz +.. .+ anz" =0, of degree n (in a complex variable 2) has exactly a solutions ,

\sepfootnotecontent{09_04}{}
\sepfootnotecontent{09_05}{}
\sepfootnotecontent{09_06}{}
\sepfootnotecontent{09_07}{}
...
places it at PAD. This is why PAD appears in the definition of \regc{GETF#}. A definition of TEXT
might be \verb|: TEXT ( delimiter --) WORD DUP C@ 1 + PAD SWAP CMOVE ;| Note that all
