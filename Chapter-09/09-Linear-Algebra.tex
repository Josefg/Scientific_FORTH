...
\begin{figure}[H]
    ...
    \begin{tikzpicture}
		\draw (0,-0.5) rectangle (10,5.5);
			...
			\node [draw=none,fill=none,anchor=west, align=left] at ($(cross) + (1,0)$) (C1) {DO (K = J TO L)};
			\node [draw=none,fill=none,anchor=west, align=left] at ($(a) + (2,0.5)$) (C2) {X G@ };
			\node [draw=none,fill=none,anchor=west, align=left] at ($(b) + (2,0.5)$) (C3) {M[I,K] G@ G*NP (::--X M[I,J]*X)};
			\node [draw=none,fill=none,anchor=west, align=left] at ($(c) + (2,0.5)$) (C4) {M[J,K] G@ GR- (::--X M[J,K]-X*M[I,K])};
			\node [draw=none,fill=none,anchor=west, align=left] at ($(dot) + (2,0.5)$) (C5) {M[J,K] G!};
			\node [draw=none,fill=none,anchor=west, align=left] at ($(dot) + (1,0.0)$) (C6)  {LOOP};
        \path [line]  (cross) -- (a);
        \path [line]  (a) -- (b);
        \path [line]  (b) -- (c);
        \path [line]  (c) -- (dot);
