...
% (2)
\begin{equation}
    \mathrm{\overleftrightarrow{A}} \cdot \vec{\mathrm{x}} = \lambda \overleftrightarrow{\rho} \cdot \vec{\mathrm{x}}
    \label{eq:09_02}
\end{equation}
...
%Fig. 9-1 
    ...
    \begin{tikzpicture}
        ...
        \path [line]  (dot) -- (end);
    \end{tikzpicture}
    \caption{Pseudocode for pivotal elimination}
    \label{fig:09_01}
\end{figure}
...
\end{verbatim} 
As with \bc{\}\}ROW*X} we avoid the execution-speed penalty of
