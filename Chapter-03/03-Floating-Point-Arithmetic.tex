...
\TallC{The} fstack words are\footnote{F@ and F! stand for a suite of words for fetching and storing 16-, 32-, 64—, and 80-bit numbers
...
Machine code definitions of the above functions for the 80x87 l
...
Of course. it would have been feasible to define, via CREATE DOES >, data types that place .
